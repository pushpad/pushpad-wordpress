...
- **Collect subscribers** that want to receive your notifications
- **Send push notifications** directly from Wordpress when you publish something new

This plugin includes the Pushpad widget and allows you to collect subscribers in different ways:
